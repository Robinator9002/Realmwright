...
interface TierBarProps {
    tierCount: number;
    // FIX: Added viewportYOffset to the interface
 ...
 */
export const TierBar: FC<TierBarProps> = ({ tierCount, viewportYOffset }) => {
    return (
        <div className="tier-bar">
            {/* NEW: Wrapper div to apply the transform for scrolling */}
            <div
                className="tier-bar__content"
                style={{ transform: `translateY(${viewportYOffset}px)` }}
            >
